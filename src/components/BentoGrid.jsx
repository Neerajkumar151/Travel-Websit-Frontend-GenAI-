...
const Card = ({ card, index }) => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 z-10 opacity-0 transition-opacity duration-700 ease-in-out bg-white/5 backdrop-blur-[2px] border-[1px] border-white/10 m-4 rounded-2xl" />
